...
use crate::game_data::{game_event_manager::{game_event_manager::game_event_manager::GameEventManager, prelude::{Event, GameEvent, PlayerDataEvent}}, locations::world_point::WorldPoint, player_data::{drone_script::var::{game_vars::game_var_type::GameVarType, var_type::VarType}, locations::location::WorldLocation}};
...
pub enum LocationEvent {
    ...
    SetAreaWithVarRef(Rc<RefCell<VarType>>),
}
    ...
    pub fn execute(&self, event_tools: &mut GameEventManager, location_ref: Rc<RefCell<WorldLocation>>) {
        match self {
            ...
            LocationEvent::SetAreaWithVarRef(var_ref) => {
                ...
                if let VarType::Game(GameVarType::Dynamic(dynamic_var_ref)) = &*borrowed {
