...
static BLOCK_PROPERTIES: [BlockProperties; 85] = [
    ...
    BlockProperties { transparent: false, translucent: true,  solid: false,  hardness: 0, friction: 0,  item: DroneItem::PlantMatter,   item_quantity: 1 },     // Dot
];
...
impl BlockTexture {
    ...
    pub fn to_string(&self) -> &'static str {
        match self {
            BlockTexture::Air => "Air",
            BlockTexture::Stone => "Stone",
            BlockTexture::Grass => "Grass",
            BlockTexture::Dirt => "Dirt",
            BlockTexture::BrownTrunk => "BrownTrunk",
            BlockTexture::Leaves => "Leaves",
            BlockTexture::PurpleTrunk => "PurpleTrunk",
            BlockTexture::Iron => "Iron",
            BlockTexture::Granite => "Granite",
            BlockTexture::Sand => "Sand",
            BlockTexture::CopperOre => "CopperOre",
            BlockTexture::PinkFungus => "PinkFungus",
            BlockTexture::BlueGrass => "BlueGrass",
            BlockTexture::MushroomStem => "MushroomStem",
            BlockTexture::PinkMushroomBlock => "PinkMushroomBlock",
            BlockTexture::MudBricks => "MudBricks",
            BlockTexture::OrangeFungus => "OrangeFungus",
            BlockTexture::StoneBrick => "StoneBrick",
            BlockTexture::FlowerStoneBrick => "FlowerStoneBrick",
            BlockTexture::Scaffolding => "Scaffolding",
            BlockTexture::PinkCloud => "PinkCloud",
            BlockTexture::DandiStem => "DandiStem",
            BlockTexture::Hive => "Hive",
            BlockTexture::CobbleStone => "CobbleStone",
            BlockTexture::Magma => "Magma",
            BlockTexture::Core => "Core",
            BlockTexture::LBM => "LBM",
            BlockTexture::CrackedEarth => "CrackedEarth",
            BlockTexture::Debug => "Debug",
            BlockTexture::Water => "Water",
            BlockTexture::Glass => "Glass",
            BlockTexture::RedBrick => "RedBrick",
            BlockTexture::DroneControler => "DroneControler",
            BlockTexture::IronOre => "IronOre",
            BlockTexture::BlueMushroom => "BlueMushroom",
            BlockTexture::StorageReceptacle1 => "StorageReceptacle1",
            BlockTexture::StorageReceptacle2 => "StorageReceptacle2",
            BlockTexture::StorageReceptacle3 => "StorageReceptacle3",
            BlockTexture::StorageReceptacle4 => "StorageReceptacle4",
            BlockTexture::StorageReceptacle5 => "StorageReceptacle5",
            BlockTexture::SmokeStack => "SmokeStack",
            BlockTexture::BrownPlanks => "BrownPlanks",
            BlockTexture::CloudBlock => "CloudBlock",
            BlockTexture::PurplePlanks => "PurplePlanks",
            BlockTexture::FurnaceOff => "FurnaceOff",
            BlockTexture::FurnaceOn => "FurnaceOn",
            BlockTexture::TitaniumOre => "TitaniumOre",
            BlockTexture::WormBody => "WormBody",
            BlockTexture::WormEyesFlat => "WormEyesFlat",
            BlockTexture::WormEyesUp => "WormEyesUp",
            BlockTexture::WormMouth => "WormMouth",
            BlockTexture::DroneBotLeft => "DroneBotLeft",
            BlockTexture::DroneBotRight => "DroneBotRight",
            BlockTexture::DroneUpLeft => "DroneUpLeft",
            BlockTexture::DroneUpRight => "DroneUpRight",
            BlockTexture::DroneDead => "DroneDead",
            BlockTexture::Battery1 => "Battery1",
            BlockTexture::Battery2 => "Battery2",
            BlockTexture::Battery3 => "Battery3",
            BlockTexture::Battery4 => "Battery4",
            BlockTexture::yellow_flowers => "yellow_flowers",
            BlockTexture::white_flowers => "white_flowers",
            BlockTexture::mushroom => "mushroom",
            BlockTexture::flungle => "flungle",
            BlockTexture::blulbo => "blulbo",
            BlockTexture::rock => "rock",
            BlockTexture::log => "log",
            BlockTexture::factory1 => "factory1",
            BlockTexture::factory2 => "factory2",
            BlockTexture::factory3 => "factory3",
            BlockTexture::conveyor1 => "conveyor1",
            BlockTexture::conveyor2 => "conveyor2",
            BlockTexture::conveyor3 => "conveyor3",
            BlockTexture::conveyor4 => "conveyor4",
            BlockTexture::conveyor5 => "conveyor5",
            BlockTexture::Selector => "Selector",
            BlockTexture::translucent_green => "translucent_green",
            BlockTexture::translucent_red => "translucent_red",
            BlockTexture::SelectorBarLeft => "SelectorBarLeft",
            BlockTexture::SelectorBarRight => "SelectorBarRight",
            BlockTexture::SelectorBarLeftRed => "SelectorBarLeftRed",
            BlockTexture::SelectorBarRightRed => "SelectorBarRightRed",
            BlockTexture::SelectorVertical => "SelectorVertical",
            BlockTexture::SelectorVerticalRed => "SelectorVerticalRed",
            BlockTexture::Dot => "Dot",
        }
    }
