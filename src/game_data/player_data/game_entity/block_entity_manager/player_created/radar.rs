use crate::game_data::{World, game_event_manager::event_manager::{Event, EventManager}, player_data::game_entity::{block_entity_manager::block_entity_manager::{BlockEntity, BlockEntityEvent, BlockEntityId}, game_entity_manager::{GameEntity, GameEntityEvent, GameEntityId}, id_gen::IdGen, components::{entity_components::EntityComponent, block_component::BlockComponent, powered_component::{PoweredComponent, PoweredComponentEvent}, vision_component::VisionComponent}}, screen::widget::{panel::panel::{Panel, PanelAlignment, PanelOrientation}, widget::WidgetType, widget_calculations::TextSize}, tik_manager::game_time::GameTime, types::BlockTexture};
