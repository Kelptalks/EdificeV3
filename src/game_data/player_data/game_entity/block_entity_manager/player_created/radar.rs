use crate::game_data::{World, game_event_manager::event_manager::{Event, EventManager}, player_data::game_entity::{block_entity_manager::block_entity_manager::{BlockEntity, BlockEntityEvent, BlockEntityId}, components::{block_components::block_component::BlockComponent, entity_components::{EntityComponent, EntityComponentEvent}, powered_component::PoweredComponent, vision_component::VisionComponent}, game_entity_manager::GameEntity}, screen::widget::{panel::panel::{Panel, PanelAlignment, PanelOrientation}, widget::WidgetType, widget_calculations::TextSize}, tik_manager::game_time::GameTime, tools::id_gen::IdGen, types::BlockTexture};
