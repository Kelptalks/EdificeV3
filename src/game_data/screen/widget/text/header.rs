use crate::game_data::{screen::{text::render_string_at_ndc, widget::{widget::Widget, widget_calculations}}, types::FontType};
...
impl Header {
    ...
    pub fn size(&mut self) {
        ...
        let char_scale =  widget_calculations::get_header_text_scale();
