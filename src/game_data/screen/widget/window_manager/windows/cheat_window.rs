use crate::game_data::{game_event_manager::player_data_event_manager::player_event_manager::PlayerDataEvent, player_data::game_entity::{block_entity_manager::{natural::flungle::BlockEntityFlungle, player_created::{battery::BlockEntityBattery, drone::BlockEntityDrone, radar::BlockEntityRadar}}, dynamic_entity_manager::natural::puff::DynamicEntityPuff}, screen::widget::{panel::panel::Panel, widget::{Widget, WidgetType}, widget_properties::WidgetId, window_manager::windows::window_type::{Window, WindowType}}, types::BlockTexture};
