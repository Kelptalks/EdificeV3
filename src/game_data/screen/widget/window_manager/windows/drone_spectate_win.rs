...
impl DroneSpectateWindow {
    pub fn new(id: DroneId) -> DroneSpectateWindow {
        ...
        let invintory_widget = InvintoryDisplayWidget::new(panel.get_widget_properties(),GameObjectId::Drone(id));
