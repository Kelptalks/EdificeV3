use crate::game_data::{player_data::player_data::PlayerData, screen::{ScreenData, menu_constructors::play_view_menu::control_panel::{building_panel, drone_panel, location_panel}, widget::{panel::panel::{Panel, PanelAlignment, PanelOrientation}, widget_calculations::TextSize}}, types::UITextures};
...
pub fn add_control_panel(panel: &mut Panel, screen_data: &ScreenData, player_data: &mut PlayerData) {
    ...
    let button = control_tab_panel.add_panel(drone_panel::drone_panel::get_drone_panel(player_data));
