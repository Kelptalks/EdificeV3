...
use crate::game_data::{game_event_manager::prelude::{Event, LocationEvent, PlayerDataEvent}, locations::world_area::WorldArea, player_data::{locations::{location::WorldLocation, location_config::{self, WorldLocationConfig}, location_manager::LocationManager}, player_data::PlayerData}, screen::{menu_constructors::play_view_menu::control_panel::location_panel::location_world_view, ui_elements::panel, widget::{panel::{panel::{Panel, PanelAlignment, PanelOrientation}, panel_color::PanelColor}, text::{header::TextDisplay, text_input::TextInput}, widget::WidgetType, widget_calculations::TextSize}}, types::UITextures};
...
pub fn get_location_panel(player_data: &mut PlayerData) -> WidgetType {
    ...
    if let WidgetType::Panel(panel) = &mut panel {
        ...
        location_world_view::add_location_world_view_panel(panel, player_data, location_config.clone());
        ...
        create_location_button.add_event(PlayerDataEvent::CreateLocation(location_config).wrap_into_event());
