...
use crate::game_data::{player_data::{drone_script::{action::{action::Action, action_type::ActionType}, function::function::Function, var::{programming_vars::programming_var::ProgrammingVar, var::Var}}, drones::drone_actions::drone_actions::DroneAction}, screen::widget::{panel::panel::{Panel, PanelAlignment, PanelOrientation}, prelude::{PanelColor, TabPanel, VarSlot}, widget::WidgetType, widget_calculations::TextSize}, types::UITextures};
...
fn get_condition_selection_panel() -> WidgetType {
    let mut panel = WidgetType::new_panel([0.0; 4], [0.0; 4]);
    if let WidgetType::Panel(panel) = &mut panel {
        panel.set_orientation(PanelOrientation::Vertical, PanelAlignment::Center);
        panel.set_color(PanelColor::Dark);
